  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Colors.white,
        title: Text('Order Details',style: Styles.largeText.copyWith(fontWeight: FontWeight.w400)),
        centerTitle: true,
      ),
      body: Padding(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        Text('Delivered',style: TextStyle(fontWeight: FontWeight.bold,color: Styles.primaryColor),)
                      ],
                    )
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 5,),
                    Text('S.c.o-135,Sahibzada Ajit Singh Nagar,Sahibzada Ajit\nSingh Nagar, Punjab',
                    style: TextStyle(color: Colors.grey,fontSize: 12),),
                  ],
                ),
                SizedBox(height: 20,),
                Text('Order ID :- 123123123123123123'),
                SizedBox(height: 20,),
                Card(
                  child: ListTile(
                    leading: Image.asset('assets/images/teblet.png',height: 40,width: 40,),
                    title: Text('Health Cart',style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),),
                    subtitle: Row(
                      children: [
                        Text('Price',style: TextStyle(fontSize: 15,color: Colors.black),),
                        SizedBox(width: 10,),
                        Text('₹ 800',style: TextStyle(color: Styles.primaryColor),),
                      ],
                    ),
                  ),
                )
